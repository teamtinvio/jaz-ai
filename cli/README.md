...
380 tools · 74 command groups · 7 skills · 13 calculators · 12 close playbooks · 159 field-tested API rules.
...
380 tools for any AI agent that speaks MCP. Runs locally: no cloud, no ports.
