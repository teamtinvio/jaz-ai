...
369 tools · 67 command groups · 7 skills · 13 calculators · 12 close playbooks · 159 field-tested API rules.
...
67 command groups, 16 report types, 13 calculators, 12 job playbooks. Every command takes `--json`. Run `clio --help` for the full list.
...
369 tools for any AI agent that speaks MCP. Runs locally: no cloud, no ports.
