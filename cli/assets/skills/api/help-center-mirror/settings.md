...
**Q12. Where can I download API documentation?**

- Go to Settings > Access Management > API > Click the View API Doc icon (beside the new API key button)
...
**Q5. How can I edit a user's permission settings?**

- You can edit permissions for a user via the sidebar on a user's profile.

**Q6. What is a Super Admin in Jaz?**
...
**Q7. What are some default permissions for an admin user?**
...
- **Note**: If Organization and User Management permissions were disabled for the Admin user, those sections will be inaccessible.**Q8. What does it mean to be a preparer or a member as a custom user?**
...
**Q9. Are there limits on the number of users or roles in Jaz?**
...
**Q10. How do I add extra custom users?**

- If you’ve reached your limit of 10 custom users, you can add more in [Plans & Add-ons](https://help.jaz.ai/en/articles/11710415-choosing-plans-add-ons).

**Q11. Once a user is deleted, can they still log in via mobile?**
...
**Q12. Can I add temporary members into my organization?**
...
**Q13. Does timed access count toward my subscription plan limit?**

- Yes. Users with timed access are included in your plan’s [total member limit](#h_3dee72fdf7) for the duration of their access.

**Q14. Where can I view the access expiry?**

- A tooltip showing the expiry will appear next to the user’s join date.

**Q15. What happens when access expires?**

- The user’s access is automatically removed from the organization.

**Q16. Can I edit the access time limit?**

- Yes. You can update or remove the access time limit anytime before it expires.

**Q17. How do I delete or deactivate an organization?**

- Go to Settings > Org Details > Deactivate Organization
- If the organization has a pending subscription, [downgrade the organization](https://help.jaz.ai/en/articles/13615676-managing-organizations-in-billing-accounts#h_4c278b3915) first and then permanently deactivate it.
- Note: This is permanent and standard data rentation still applies.
...
**Q4. Can I import exchange rates in bulk?**

- Yes. Click **Import Exchange Rates**, download the template, fill it out, then upload the completed file.**Q5. How can I set exchange rates for a currency?**
...
- You can also bulk delete by selecting multiple accounts and choosing **Delete**.**Q5. Why can't I delete an account?**
...
- **Monthly movement**refers to the net cash flow for the account in a month. In other words:
  - **Monthly movement = Cash-in to the account - cash-out of the account.Q14. Can I remove an account's lock date? Will it impact my existing transactions?**
...
- A currency can only be set for accounts of type **Asset - Cash**and **Asset - Bank Account**.**Q16. Can I change the currency of an account? What can I do if I have wrongly set up a currency?**
...
- Go to **Settings >**under **Configurations** > click on**Custom Fields.**
- Click on **+ New Field** to add a custom field. This will bring up the**New Custom Field **screen.
  - **Print on documents**: Toggle this on/off to enable printing the custom field on relevant documents.
- Custom Fields can be applied in the following activities:
  - Invoices and Bills
  - Contacts
...
- After creating a custom field, it will appear as an input field in the activities it applies to.
  - For Invoices, Bills, and Credit Notes, custom fields appear in the function tab on the right (or press F while in edit mode).
  - For other activities such as Contacts, they appear as a regular field.
- Click the field to input values.
- If the **Print on document**has been toggled off, the custom field will not be printed on the transaction document headers. However, you can still enter a value for the custom field.
  ...
  - However, the value **SALES-001**can still be entered and saved, which can be viewed internally.
...
**Q3. How do I edit Custom Fields?**

- Go to **Settings >**under **Configurations**> click on **Custom Fields**
- Click on the **menu icon (3 dots)**, and choose**Edit Custom Field.Q4. Will changing the Custom Field affect existing data?**
...
- Go to **Settings >**Under **Configurations** > click on**Custom Fields**
- Click on the **menu icon (3 dots)** >**DeleteQ7. Will deleting a Custom Field affect existing data?**
...
**Q1. How do I add a new GST profile?**

- Under **Settings > Configurations > GST Profiles Profiles**
- Clicking on **+ New Profile** will add a new GST profile.
- The newly created GST profile should show up in the list of GST profiles.

**Q2. How do I edit a GST profile?**

- Under **Settings > Configurations > GST Profiles**
- Click on the **menu (3 dots) on your desired GST profile to edit**, and choose**Edit.**
- Modify the fields (name, type or rate) as desired.

**Q3. How do I use a GSTprofile?**

Before using GST profiles in business transactions, you must first adjust the transaction GST settings under the transaction settings**.**
- Choose between **GST Included in Price**or **GST Excluded in Price.**
- After selecting either GSTincluded in Price or GST excluded in Price, a new **Select GST**field will appear.
- You can choose from the pre-existing GST profiles, or select profiles that were added in.
- The tax amounts will then be updated accordingly, on the transaction total summary.

**Q4. Can I use a GST profile for shipping?**

- Yes, you can use a GST profile for shipping.
- For more information, refer to [How can I add GST for shipping fees to my invoice?](https://help.jaz.ai/en/articles/9062234-create-an-invoice#h_657e2a438b)

**Q5. What is a GST type?**

- GST Type refers to the categorization of the GST profile.
- This is pre-selected by Jaz. New GST profile types cannot be added in.

**Q6. Will changing or deleting the GST profile affect existing data?**

- If you change the GST profile via **Configurations**, the change will show up in any transactions that will make use of the GST profile moving forward. Transactions already created will not be affected.
- However, if the change is made on a transaction level, only the GST profile for the transaction itself will be affected.
...
- The Aged Payables (Line Items) template supports the following columns:
  - Adjustable:
    ...
    - Note: Transaction Date, Due Date, and Supplier Name are locked. This means you cannot hide or re-arrange them. (SGD) pertains to the org’s default currency.
...
**Q5. What is the decorator function in Template Style for?**

- Turning on decorators for Template styles adds a horizontal line on top of the report.

**Q6. What is the uppercase function in Fonts for?**

- Turning on uppercase converts all text in the report to uppercase.

**Q7. Can I add a logo to my Aged Payables (Line Items) Template?**

- Yes, go to **Template Settings** >**PDF** > Add a logo
- Logo file should only be up to 1mb with min width: 120px and min height: 60px

**Q8. What is the dynamic string in the PDF Date Title for?**

- You can use the dynamic string for dates to configure your date title according to your preferred format.

**Q9. How do I duplicate an Aged Payables (Line Items) template?**

- Go to **Settings** >**Templates** > **Reports > Additional Tab**, hover over the template, click the three-dot icon, and select**Duplicate**.**Q10. What happens when I update an Aged Payables (Line Items) template?**
...
- The Aged Payables (Summary Totals) template has two tabs: General and PDF.
  - General: Edit template name, baseline period, header, and footer.
  - PDF: Customize layout, header, and footer for PDF version of the report.
    - Note: PDF preview and export are only supported for up to 8 columns.
...
- The Aged Payables (Summary Totals) template supports the following columns:
  - Adjustable:
    ...
    - Contact Group
    - Contact Relationship
    - Note: Supplier Name is locked. This means you cannot hide or re-arrange them. (SGD) pertains to the org’s default currency.
...
**Q7. Can I add a logo to my Aged Payables (Summary Totals) Template?**
...
**Q9. How do I duplicate an Aged Payables (Summary Totals) template?**

- Go to **Settings** >**Templates** > **Reports > Additional Tab**, hover over the template, click the three-dot icon, and select**Duplicate**.**Q10. What happens when I update an Aged Payables (Summary Totals) template?**
...
- The Aged Receivables (Line Items) template has two tabs: General and PDF.
  - General: Edit template name, baseline period, header, and footer.
  - PDF: Customize layout, header, and footer for PDF version of the report.
    - Note: PDF preview and export are only supported for up to 8 columns.
...
- The Aged Receivables (Line Items) template supports the following columns:
  - Adjustable:
    ...
    - Contact Group
    - Contact Relationship
    - Note: Transaction Date, Due Date, and Customer Name are locked. This means you cannot hide or re-arrange them. (SGD) pertains to the org’s default currency.
...
**Q7. Can I add a logo to my Aged Receivables (Line Items) Template?**
...
**Q9. How do I duplicate an Aged Receivables (Line Items) template?**

- Go to **Settings** >**Templates** > **Reports > Additional Tab**, hover over the template, click the three-dot icon, and select**Duplicate**.**Q6. What happens when I update an Aged Receivables (Line Items) template?**

- Changes apply automatically. For previously downloaded reports, redownload them to apply updates.

**Q10. What happens when I update an Aged Receivables (Line Items) template?**
...
- The Aged Receivables (Summary Totals) template has two tabs: General and PDF.
  - General: Edit template name, baseline period, header, and footer.
  - PDF: Customize layout, header, and footer for PDF version of the report.
    - Note: PDF preview and export are only supported for up to 8 columns.
...
- The Aged Receivables (Summary Totals) template supports the following columns:
  - Adjustable:
    ...
    - Contact Group
    - Contact Relationship
    - Note: Customer Name is locked. This means you cannot hide or re-arrange them. (SGD) pertains to the org’s default currency.
...
**Q7. Can I add a logo to my Aged Receivables (Summary Totals) Template?**
...
**Q9. How do I duplicate an Aged Receivables (Summary Totals) template?**

- Go to **Settings** >**Templates** > **Reports > Additional Tab**, hover over the template, click the three-dot icon, and select**Duplicate**.**Q10. What happens when I update an Aged Receivables (Summary Totals) template?**
...
- To add a Text Row, hover and select **+Text Row** (available for both group and child levels).**Q7. Can I rename group-level rows in the Balance Sheet template?**
...
- Go to **Settings** >**Templates** > **Reports**, hover over the template, click the three-dot icon, and select**Duplicate**.**Q20. What happens when I update a Balance Sheet template?**
...
- The Cash Balance template has three tabs: General, PDF, and Actions.
  - General: Edit template name, baseline period, header, and footer.
  - PDF: Customize layout, header, and footer for PDF version of the report.
    - Note: PDF preview and export are only supported for up to 8 columns.
  - Actions: Perform specific functions on a selected column.
...
- The Cash Balance template supports the following columns:
  ...
  - Adjustable:
    ...
    - Balance
    - Balance (SGD)
    - Note: Account Code and Account Name are locked. This means you cannot hide or re-arrange them. (SGD) pertains to the org’s default currency.
...
**Q7. Can I add a logo to my Cash Balance Template?**
...
**Q9. How do I duplicate a Cash Balance template?**

- Go to **Settings** >**Templates** > **Reports**, hover over the template, click the three-dot icon, and select**Duplicate**.**Q10. What happens when I update a Cash Balance template?**
...
### GST Ledger Template
Source: https://help.jaz.ai/en/articles/14354811-gst-ledger-template

**Q1. How do I create a new GST Ledger template?**

- Go to **Settings** >**Templates** > **Reports** >**Accounting Tab**, then click**New Template** (GST Ledger).
- Alternatively, in **Reports** >**GSTLedger**, click the template selector (top right) and choose New Template.**Q2. What settings can I customize in my GST Ledger template?**

- The Ledger template has two tabs: General and PDF.
  - General: Edit template name, baseline period, header, and footer.
  - PDF: Customize layout, header, and footer for PDF version of the report.
    - Note: PDF preview and export are only supported for up to 8 columns.
...
- The GST Ledger template supports the following columns:
  - Adjustable:
    - Date (locked)
    - Transaction (locked)
    - Description (locked)
    ...
    - GST (Source)
    - GST Type
    - Note: Date, Transaction, and Description are locked. This means you cannot hide or re-arrange them. (SGD) pertains to the org’s default currency.

**Q4. How do I select/hide/arrange columns in the GST Ledger template?**
...
**Q5. What is the dynamic string in the PDF Date Title for?**

- You can use the dynamic string for dates to configure your date title according to your preferred format.

**Q6. How do I duplicate a GST Ledger template?**

- Go to **Settings** >**Templates** > **Reports**, hover over the template, click the three-dot icon, and select**Duplicate**.**Q7. What happens when I update a GST Ledger template?**
...
**Q6. How do I duplicate a Ledger template?**

- Go to **Settings** >**Templates** > **Reports**, hover over the template, click the three-dot icon, and select**Duplicate**.**Q7. What happens when I update a Ledger template?**
...
- The Trial Balance template has three tabs: General, PDF, and Actions.
  ...
  - **Actions:** Specific actions you can do when you click on an element in the template.**Q3. What is the decorator function in Template Style for?**
...
**Q6. Can I add a logo to my Trial Balance Template?**

- Yes, go to Template Settings > PDF > Add a logo
- Logo file should only be up to 1mb with min width: 120px and min height: 60px

**Q7. What columns are supported in the Trial Balance template?**
...
- The Trial Balance template supports the following columns:
  ...
  - **Adjustable**:
    ...
    - Debit (Source)
    - Credit (Source)
    - Note: Account Code and Account Name columns are locked. Debit and Credit columns cannot be hidden. (SGD) pertains to the org’s default currency.

**Q8. Can I change the display currency?**

- Yes, to change the display currency, click the base currency.
- The report will be converted from base currency to display currency at the exchange rate on report date. If there're multiple periods, all periods will be converted at the same exchange rate.

**Q9. How do I select/hide/arrange columns in the Trial Balance template?**
...
**Q10. How do I duplicate a Trial Balance template?**

- Go to **Settings** >**Templates** > **Reports**, hover over the template, click the three-dot icon, and select**Duplicate**.**Q11. What happens when I update a Trial Balance template?**
