...
description: >-
  ...
  67 command groups and 369 tools, including employee-expense claims.
license: MIT
...
You are working with **Clio** (`jaz-clio`) — the CLI for the Jaz accounting platform. 67 command groups, 13 calculators, 12 job blueprints, 369 tools. Also fully compatible with Juan Accounting (same API, same endpoints).
