...
description: >-
  ...
  Covers all 65 command groups and 354 tools.
license: MIT
...
You are working with **Clio** (`jaz-clio`) — the CLI for the Jaz accounting platform. 65 command groups, 13 calculators, 12 job blueprints, 354 tools. Also fully compatible with Juan Accounting (same API, same endpoints).
