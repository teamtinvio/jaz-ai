...
import type { AddBankRecordEntry, BankAccount, BankRecord, PaginatedResponse, PaginationParams } from './types.js';
...
export async function addBankRecords(
  client: JazClient,
  accountResourceId: string,
  records: AddBankRecordEntry[],
): Promise<{ data: { errors: unknown[] } }> {
