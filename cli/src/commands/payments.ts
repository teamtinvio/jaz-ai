  ...
  payments
    ...
    .action((resourceId: string, opts) => apiAction(async (client) => {
      ...
      if (opts.json) {
        ...
        console.log(highlight('Amount:'), p.paymentAmount);
        console.log(highlight('Date:'), p.valueDate);
        console.log(highlight('Method:'), p.paymentMethod);
        console.log(highlight('Reference:'), p.reference);
      }
    })(opts));
  ...
  payments
    ...
    .action((resourceId: string, opts) => apiAction(async (client) => {
      ...
      if (opts.json) {
        ...
        console.log(success(`Payment ${resourceId} updated.`));
      }
    })(opts));
  ...
  payments
    ...
    .action((resourceId: string, opts) => apiAction(async (client) => {
      ...
      if (opts.json) {
        ...
        console.log(success(`Payment ${resourceId} deleted.`));
      }
    })(opts));
}
