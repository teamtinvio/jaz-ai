      ...
      return apiAction(async (client) => {
        ...
        switch (type as ReportType) {
          ...
          case 'bank-recon-summary':
            if (!opts.bankAccount) { console.error(chalk.red('--bank-account is required for bank-recon-summary')); process.exit(1); }
          ...
          case 'bank-recon-details':
            if (!opts.bankAccount) { console.error(chalk.red('--bank-account is required for bank-recon-details')); process.exit(1); }
