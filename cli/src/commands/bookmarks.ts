...
const BOOKMARKS_COLUMNS: TableColumn[] = [
...
export function registerBookmarksCommand(program: Command): void {
  ...
  bm
    ...
    .action(apiAction(async (client, opts) => {
      ...
      outputList(result as any, BOOKMARKS_COLUMNS, opts as OutputOpts, 'Bookmarks');  // eslint-disable-line @typescript-eslint/no-explicit-any
    }));
