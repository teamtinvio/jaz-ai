...
- To add taxes for an invoice, ensure that you have selected a **GST setting** under**default GST**, either**GST Included in Price** or **GST Excluded in Price**.
...
**Q22. How can I add GST for shipping fees to my invoice?**

- To add **GST**for shipping fees to your invoice, select a **GSTProfile**when adding shipping fees to your invoice. Refer to [Q20. How can I add shipping fees to my invoice?](#h_09f65610c2) to learn more about adding shipping fees.
...
### Invoice Attachments (External and Internal)
Source: https://help.jaz.ai/en/articles/9094433-invoice-attachments-external-and-internal

**Q1. How can I upload attachments to an invoice?**

- You can add attachments when creating an invoice. There are two types:
  - **External attachments:** Included in the invoice email sent to your customers.
...
- Customers can only see **external attachments** when the invoice email is sent to them.**Internal attachments** are visible only to users in your organization who have access to the invoice.
...
- Ensure that a GST setting has been selected (GST included in price or GST excluded in price) via the **Invoice Settings.**
...
- While there are no strict restrictions on the type of account you can select for an item in an invoice, Jaz will **warn you** if you have selected an account that is not a**Revenue Account**.**Q5. Why do I not see all the GST profiles created in an invoice?**

- Some of your previously created GST profiles may only apply to other business transactions such as bills or supplier credits. As such, you may not be able to select them for your invoice.
...
**Q2. Can I customize invoice notes?**

- Yes. Click the customize icon beside Invoice Notes to edit them. Your changes will appear in the invoice PDF and will be seen by your customer.

**Q3. Why has the invoice notes section been automatically filled in?**
...
**Q2. How to remove GST, item discount, or item quantity & unit from appearing in the invoice?**
...
**Q10. How to adjust GST in Invoices?**

- Click the GST amount in the totals section when editing an invoice transaction.

**Q11. Which transactions allow GST adjustments?**
...
**Q12. What impact will GST adjustments have?**
...
**Q13. Where can I see reports showing GST adjustments?**
...
### Sending Invoices
Source: https://help.jaz.ai/en/articles/13870498-sending-invoices

**Q1. How do I send an invoice?**

- Open the invoice and click the email icon to send it directly from the app.
- You can also click the download icon to download the invoice PDF and send it using your own email provider.

**Q2. Can I preview an invoice before sending it?**

- Yes. Open the invoice in edit mode and click the email icon (or press E) to preview the email.
- To preview the PDF attachment, click the Preview PDF icon (or press P).

**Q3. Can I include additional email addresses when sending an invoice?**

- Yes. You can CC other users within your organization or manually enter external email addresses.

**Q4. Can I resend an invoice?**

- Yes. Open the invoice and click the email icon again to resend it.

**Q5. Can I customize my invoice based on my brand?**

- Yes. You can customize your invoice by editing your invoice template. Refer to the [PDF Templates](https://intercom.help/jaz-accounting/en/articles/10483242-pdf-templates) for details.

**Q6. Can I schedule an invoice to be sent later?**

- You cannot set a specific future send time for a one-time invoice.
- However, you can create a recurring invoice, which automatically sends invoices based on a set schedule.

**Q7. Can I send invoices in bulk?**

- Bulk sending of invoices is not currently supported. To automate sending, set up [recurring invoices](https://help.jaz.ai/en/articles/9062579-scheduled-and-recurring-invoices) or [subscription schedulers](https://help.jaz.ai/en/articles/11507704-scheduled-and-recurring-sales-subscriptions).

**Q8. Can customers pay directly from the invoice?**

- Yes. Enable online payments to allow customers to pay directly from the invoice.

**Q9. Can I attach files when sending an invoice?**

- File attachments cannot be added directly within the invoice email. Instead, you can download the invoice PDF and send it using your own email provider with attachments.
- Alternatively, you may include a file link in the invoice before sending.

**Q10. Can I edit an invoice after sending it?**

- Yes. You can edit a sent invoice.
- Customers will not be automatically notified of the changes, so you must resend the invoice email.
- If online payments are enabled and you change the invoice amount after sending, the updated amount will reflect when the customer clicks the Pay Online button.

**Q11. Can I void a sent invoice?**

- Yes. You can void a sent invoice.
- The customer will not be automatically notified, so you should manually inform them and send a new invoice if necessary.

**Q12. Can I send an invoice using the mobile app?**

- Sending invoice emails directly from the mobile app is not currently supported.
- You can download the invoice PDF and send it using your mobile email app.
...
- Yes. Invoices in Jaz include built-in audit details to help you track changes and actions.
...
**Q6. How can I view the ledger entry of an invoice?**

- Open the invoice, click the three-dot icon, and select **See Ledger** to view the journal entry created by the invoice.**Q7. Where can I find the exchange rate for an invoice with non-base currency?**
...
**Q8. What happens if the exchange rate changes after I have viewed the invoice?**
...
**Q9. What is the lifecycle of an invoice? What different states or stages does it go through?**
...
- On the invoice details, the payment amount shown in the invoice total summary will reflect the **Gross Cash Received**or the cash received before fees**.Q4. How does recording GST work for transaction fees?**

- You can add a GST included in the fee.
- You just need to select a tax profile and Jaz will calculate the actual fees and the included GST.
...
- If you have added **GST included** in the transaction fees, you should see an additional record for the included GST under the**Input GST Receivable **account.
...
**Q5. How can I view the ledger entry of an invoice payment?**

- Open the invoice payment, click the three-dot icon, and select **See Ledger** to view the journal entry created by the payment.
