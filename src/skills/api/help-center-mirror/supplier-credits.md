...
**Q6. How can I convert a draft refund record to an active one?**
...
**Q7. Can I delete a draft supplier credit?**
...
**Q8. Do draft supplier credits affect my financial reports?**
...
**Q9. Can I create a non-base draft supplier credit note?**

- Yes, you can save a supplier credit note as a draft even if it is in non-base currency.

​

**Q10. Do draft supplier credit refunds affect my financial reports?**

- No, draft supplier credit refunds do not affect financial reports. ​

**Q11. Can I create a non-base draft supplier credit refund?**
...
- Yes. Use Jaz Magic by simply uploading attachments or drag and drop files into the supplier credit list view. This will create draft entries per file.

**Q2. What files are supported for Jaz Magic (Customer Credit)?**

- Jaz Magic extraction supports most image files such as .jpg or .png and .pdf files.

**Q3. How many files can I upload at once?**

- It is recommended to upload a maximum of 50 files at a time. Jaz Magic extraction may take several seconds to process, depending on the data.
...
- To add taxes for a supplier credit note, ensure that you have selected a **GST setting** under default**GST**, either**GST Included in Price** or **GST Excluded in Price**.
...
- While there are no strict restrictions on the type of account you can select for an item in a supplier credit note, Jaz will **warn you** if you have selected an account that is not an**Expense **or**Asset Account**.**Q5. Why do I not see all the GST profiles created in a supplier credit note?**

- Some of your previously created GST profiles may only apply to other business transactions such as invoices or customer credits. As such, you may not be able to select them for your supplier credit note.
...
**Q2. How can I remove GST, item discount, or item quantity & unit from appearing in the supplier credit note?**
...
**Q9. How to adjust GST in Supplier Credit Notes?**

- Click the GST amount in the totals section when editing a supplier credit note transaction.
