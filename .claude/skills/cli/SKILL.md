...
description: >-
  ...
  74 command groups and 379 tools, including employee-expense claims.
license: MIT
...
You are working with **Clio** (`jaz-clio`) — the CLI for the Jaz accounting platform. 74 command groups, 13 calculators, 12 job blueprints, 379 tools. Also fully compatible with Juan Accounting (same API, same endpoints).
